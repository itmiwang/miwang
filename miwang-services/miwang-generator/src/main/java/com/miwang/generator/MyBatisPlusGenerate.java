...
public class MyBatisPlusGenerate {
	 ...
	 * 作者
	 */
	private static final String AUTHOR = "guozq";
	 ...
	 * JDBC 连接地址
	 */
	private static final String JDBC_URL = "jdbc:mysql://localhost:3306/dmy?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&nullNamePatternMatchesAll=true&zeroDateTimeBehavior=CONVERT_TO_NULL&tinyInt1isBit=false&autoReconnect=true&useSSL=false&pinGlobalTxToPhysicalConnection=true";
	 ...
	 * 包配置 - 父级目录
	 */
	private static final String PACKAGE_PARENT = "com.miwang";
	 ...
	 * 要生成的表，用 `,` 分割
	 */
	private static final String TABLES = "core_order";

	/**
	 * 通用包路径
	 */
	private static final String PACKAGE_BASE = "com.miwang.commons.base";
	...
	private static PackageConfig packageConfig() {
		...
		// 设置模块的名字，比如 core，生成效果为 com.miwang.core
	...
	private static StrategyConfig strategyConfig() {
		...
		// tableFields.add(new TableFill("is_deleted", FieldFill.INSERT));
		// tableFields.add(new TableFill("create_time", FieldFill.INSERT));
		// tableFields.add(new TableFill("update_time", FieldFill.INSERT_UPDATE));
		// config.setTableFillList(tableFields);
		// CommonBase
		config.setSuperEntityColumns("id", "is_deleted", "create_time", "update_time");
